    ...
    <div class="target_contents_inner">
      ...
      <div class="target_tbody">
        ...
        <div class="btn_wrap">
          ...
          <button type="button" class="next_btn" @click="createUtmTarget()" v-if="makeType == 'add'">타겟 만들기</button>
          <button type="button" class="delete_btn" @click="deleteUtmTarget()" v-if="makeType == 'modify'">삭제</button>
          <button type="button" class="next_btn" @click="updateUtmTarget()" v-if="makeType == 'modify'">타겟 수정하기</button>
        </div>
      </div>
    </div>
  </div>
